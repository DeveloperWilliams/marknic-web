...
const GroupLoansPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-red-50">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                ...
                <Image
                  src="/images/group-loan.svg" // replace with actual group loan image path
                  alt="Group Loan Hero Image"
                  width={600}
                  height={600}
      ...
      <div
        id="calculator"
        className="py-16 bg-gradient-to-r from-blue-100 via-white to-rose-100 text-white"
      >
        <div className="container mx-auto px-4">
      ...
      {/* CTA Section */}
      <div className="py-16 bg-gradient-to-r from-blue-200 via-grey to-rose-300 text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <ShieldCheckIcon className="h-16 w-16 mx-auto text-grey mb-6" />
            <h2 className="text-3xl font-bold mb-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <button className="bg-transparent border-2 border-grey-900 text-black font-bold px-8 py-4 rounded-lg hover:bg-white/10 transition-all">
