...
const PersonalLoansPage = () => {
  ...
  const features = [
    ...
    {
      title: "Flexible Use",
      description: "Use for any purpose - education, home, travel, or emergencies",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4">Why Choose Our Personal Loans</h2>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-red-50 rounded-xl p-6 h-full">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold">{new Intl.NumberFormat('en-KE', { style: 'currency', currency: 'KES' }).format(loanAmount * 0.03)}</span>
                      </div>
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4">Getting Your Personal Loan</h2>
            <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <p className="ml-3">Employment: Minimum 6 months at current job</p>
                </li>
                <li className="flex items-start">
                  <div className="bg-blue-100 p-1 rounded-full mt-1">
                    <CheckCircleIcon className="h-5 w-5 text-blue-600" />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <p className="ml-3 font-medium">Flexible repayment terms (3-48 months)</p>
                </li>
              </ul>
            </div>
          </div>
